    ...
    <div className='bg-[#F9F8FE] py-10 xs:px-[3%] sm:px-[5%] md:px-[8%] lg:px-[8%] xl:px-[8%] bg-gradient-to-r  from-[#FAF1DF] to-[#E2F3EB]  '>
        ...
        <div className='w-full xs:gap-6 xs:flex-col py-12 xs:py-2 flex justify-between '>
            <div className='w-[50%] xs:w-full'>
                ...
                <p className='flex  gap-2 items-center text-[18px] font-inter font-medium text-[#191A15]'> <CiCircleCheck  className='w-[20px] h-[20px]'/>Personalize it to reflect your wishes</p>
                ...
                <p className='flex  gap-2 items-center text-[18px] font-inter font-medium text-[#191A15]'><CiCircleCheck  className='w-[20px] h-[20px]'/>
                Complete in just 15 minutes.</p>
                ...
                <div className='mt-6'>
                    <Link href="/willq&a"
                    className='px-6 py-3 rounded-3xl bg-[#54BD95]  text-white font-inter '
